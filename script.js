...
Vue.component("app-goods-list", {
    props: ["goods", "addToBasket"],
    template: `<div>
                <app-goods-item v-bind:id="item.id_product" v-bind:name="item.product_name" v-bind:price="item.price" v-for="item in goods" :key="item.id_product">
                </app-goods-item>
            </div>`
});

Vue.component("app-goods-item", {
    props: ["id", "name", "price", "addToBasket"],
    template: `
...
Vue.component("app-backet-list", {
    ...
    template: `
        <div>
            <app-backet-item v-bind:id="item.id_product" v-bind:name="item.product_name" v-bind:price="item.price" v-for="item in goods" :key="item.id_product></app-backet-item>
        </div>
    `
});
